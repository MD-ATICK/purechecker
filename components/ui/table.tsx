...
>(({ className, ...props }, ref) => (
	<thead
		ref={ref}
		className={cn("[&_tr]:border-b bg-secondary hover:bg-secondary", className)}
		{...props}
	/>
));
...
>(({ className, ...props }, ref) => (
	<td
		ref={ref}
		className={cn(
			"p-4 py-4   whitespace-nowrap align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
			className,
		)}
		{...props}
	/>
