...
export const PurchaseMail = (values: { name: string, email: string, amount: number, type: "PURCHASE" | "SUBSCRIPTION", credit: number, createdAt: string }) => (
    <Html>
        <Head />
        <Preview>
            You have been made a purchase in our website.
        </Preview>
        <Body style={main}>
