        ...
        <div className=' container md:pb-32 px-4 pt-8 space-y-6 md:space-y-20 mx-auto text-center flex justify-center items-center flex-col'>
            ...
            <div className=' flex flex-col md:flex-row items-center gap-10'>
                <div className='  md:space-y-4 flex flex-col justify-center items-center'>
                    <Image alt='' src={secure} height={300} className=' aspect-[16/11]  object-cover' />
                ...
                <div className='  md:space-y-4 flex flex-col justify-center items-center'>
                    <Image alt='' src={optimized} height={300} className=' aspect-[16/11]  object-cover' />
                ...
                <div className='  md:space-y-4 flex flex-col justify-center items-center'>
                    <Image alt='' src={cheapPrice} height={300} className=' aspect-[16/11]  object-cover' />
