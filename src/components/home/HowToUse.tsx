    ...
    return (
        ...
        <div className=' container z-10  md:py-[3.4vw] mx-auto text-center'>
            <div className=' text-center w-full p-4 md:w-3/5 mx-auto space-y-6'>
                ...
                <p className=' text-xs text-muted-foreground sm:text-base'>Never waste time with undeliverable emails again! Pure Checker’s bulk email checker helps you validate a large list of email addresses in seconds.</p>
            </div>
            <br />
