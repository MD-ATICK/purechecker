...
export default function NotVerifiedMessage({ email }: { email: string }) {
    ...
    return (
        <div className=" h-20 z-50 text-yellow-500 p-2 flex-col bg-[#413907] backdrop-blur-lg border-t-yellow-500 flex  justify-center text-sm gap-3 items-center w-full fixed top-[60px] bottom-0 left-0">
