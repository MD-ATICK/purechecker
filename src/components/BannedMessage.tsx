...
export default function BannedMessage() {
    return (
            <div className=" h-16 z-50 border border-red-500 w-full fixed gap-2 bottom-0 top-[calc(100vh-64px)] left-0 text-center flex justify-center backdrop-blur-lg bg-[#3d0606] items-center">
