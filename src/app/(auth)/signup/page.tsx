            ...
            <div className=" shadow-2xl flex flex-col-reverse md:flex-row h-full md:max-h-[95%] w-full max-w-[64rem] md:rounded-2xl overflow-hidden md:bg-background border">
                <div className=' w-full md:w-1/2 h-full p-[6vw] md:p-[3vw] flex flex-col gap-4'>
                    <div className=' space-y-1'>
                        ...
                        <p className=' text-sm md:text-[15px] text-gray-400'>Create Your PureChecker Account</p>
                    </div>
                    <SignUpForm />
                ...
                <div className=" w-full aspect-[10/9] md:w-1/2 bg-gradient-to-r p-6 flex-col gap-2 to-blue-700 from-blue-800 flex justify-center items-center text-center md:h-full relative">
                    <h1 className=" font-bold leading-[55px] text-5xl">Get 100 FREE verifications or 20 free search!</h1>
