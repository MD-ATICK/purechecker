...
export default function ResultPart({ checkedEmails, setCheckedEmails, isChecking }: { isChecking: boolean, checkedEmails: BulkDownloadEmailType[], setCheckedEmails: React.Dispatch<React.SetStateAction<BulkDownloadEmailType[]>> }) {
                ...
                </div>
                {
                    checkedEmails.length > 0 && (
                        <div className=" flex items-center gap-2">
                            <DownloadDialog isChecking={isChecking} checkEmails={checkedEmails} />
