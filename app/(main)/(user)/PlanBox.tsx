  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className=" outline-none w-full">
        <div className=" hover:bg-gray-800/10 mb-2 rounded-md w-full shadow-sm flex items-center gap-3 lg:p-2">
          <Image
      ...
      <DropdownMenuContent align="end" className=" p-2 min-w-[280px] ">
        ...
        {subscription && (
          <DropdownMenuItem className=" flex flex-col gap-0">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <p className=" text-xs">
                {subscription.volume.dailyCredit ||
                  subscription.volume.credit /
                    Number(
                      process.env.NEXT_PUBLIC_SUBSCRIPTION_DAY_LENGTH || 30
                    )}
              </p>
            </div>
            <div className="flex items-center justify-between w-full">
