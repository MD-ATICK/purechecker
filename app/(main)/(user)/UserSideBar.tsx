...
export default function UserSideBar({
	...
	return (
		<div
			className={cn(
				className,
				" lg:px-2 min-w-[50px] overflow-hidden h-screen p-1 z-50 bg-gradient-to-tr to-background via-sky-600/20 from-background flex flex-col justify-between items-start",
			)}
		>
