...
export default function DownloadDialog({
  ...
  isChecking?: boolean;
  checkEmails: BulkDownloadEmailType[];
}) {
  ...
  const onsubmit = async (values: DownloadEmailValues) => {
    ...
    startTransition(async () => {
      if (values.type === "pdf") {
        ...
        generateXLSX(values.fileName, margeData);
      } else if (values.type === "csv") {
        generateCSV(values.fileName, margeData);
      }
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <DialogDescription>
          Download your email verification results as a file for easy access,
