...
export default async function HeaderStats({ deliverable, unDeliverable, apiUsage }: { deliverable: number, unDeliverable: number, apiUsage: number }) {
    ...
    return (
        <div className=" w-full md:h-[100vh] bg-sky-50 md:sticky top-0 right-0 md:w-[260px] flex flex-col gap-6">
            <div className=" h-full w-full px-6 md:px-10  shadow-sm  border-b-2">
            ...
            <div className=" h-full w-full px-6 md:px-10  shadow-sm ">
