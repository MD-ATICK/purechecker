...
import { ToolbarCo } from "./components/toolbar-co";
import Image from "next/image";
import { Button } from "@/components/ui/button";
import LoadingButton from "@/components/LoadingButton";
import { cn } from "@/lib/utils";
import ArrayInput from "./components/tags-input";
			...
			<div className=' py-4 space-y-2'>
				...
				{!image && (
					<UploadButton
						...
						className=' bg-gray-400 py-4 rounded-sm border '
				...
				<div className=' h-full relative'>
					...
					/>
					<p
						className={cn("absolute bottom-2 right-2 text-xs", {
							"text-red-500": description.length > 140,
						})}
					>
						{description.length}/140
					</p>
